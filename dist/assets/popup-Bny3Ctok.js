...
const App = () => {
  const [stories, updateStories] = reactExports.useState();
  reactExports.useEffect(() => {
    chrome.storage.local.get(["stories"]).then((result) => {
      updateStories(result.stories);
    });
    chrome.storage.onChanged.addListener((changes) => {
      updateStories(changes.stories.newValue);
    });
  ...
  if (!stories) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-screen flex justify-center items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-lg text-center text-white", children: "No Stories Found 😴" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-lg text-center text-white", children: "Stories (click to save)" }) }),
    stories.map((story) => {
      var _a;
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: (_a = story == null ? void 0 : story.updatedMedias) == null ? void 0 : _a.map((media) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: media.type === "Photo" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: media.href.mediaHref,
          alt: media.type,
          onClick: () => {
            chrome.runtime.sendMessage({
              type: "download",
        ...
        "video",
        {
          ...
          playsInline: true,
          loop: true,
          poster: media.href.thumbnailHref,
          onClick: () => window.location.href = media.href.mediaHref,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("source", { src: media.href.mediaHref })
        }
      ) }, media.id)) }, story.postItemId);
    })
  ] });
};
ReactDOM.render(
